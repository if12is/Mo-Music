          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Obx(() {
                  if (searchResScrController.filters.isEmpty) {
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final filterName =
                            searchResScrController.filters[index];
                        final isSelected =
                            searchResScrController.currentFilter.value ==
                                filterName;
                        ...
                        return Padding(
                          ...
                          child: ActionChip(
                            ...
                            onPressed: () =>
                                searchResScrController.applyFilter(filterName),
                          ),
                        );
                      },
                    ),
